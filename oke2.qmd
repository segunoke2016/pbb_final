...
---
title: "GAPMINDER | LIFE EXPECTANCIES 2002"  
format: dashboard
#execute:
 #  echo: false
  #output: false
...
itables.show(gap_02, caption="Gapminder Dataset (2002)", buttons=["csvHtml5"])
```
